...
type _SyntheticEvent<M extends object = object, B extends Event = Event> = SyntheticEvent<M, B>;

// type namespace.
declare namespace eventManager {
	export type SyntheticEvent<M extends object = object, B extends Event = Event> = _SyntheticEvent<
		M,
		B
	>;
}
